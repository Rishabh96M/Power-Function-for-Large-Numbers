Now that you have read \mbox{\hyperlink{_v1__5___primer_8md}{Primer}} and learned how to write tests using Google Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md149}{}\doxysection{More Assertions}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md149}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md150}{}\doxysubsection{Explicit Success and Failure}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md150}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md151}{}\doxysubsection{Exception Assertions}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md151}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+1.\+0.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md152}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md152}
...
Google Test gives you three different options to solve this problem\+:\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md153}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md153}
...
{\itshape Availability}\+: Linux, Windows, Mac\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md154}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md154}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+4.\+1.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md155}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md155}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md156}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md156}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md158}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md158}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md159}{}\doxysubsection{Windows H\+R\+E\+S\+U\+L\+T assertions}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md159}
...
{\itshape Availability}\+: Windows.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md160}{}\doxysubsection{Type Assertions}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md160}
...
{\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md161}{}\doxysubsection{Assertion Placement}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md161}
...
If you want to test {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()/\+A\+S\+S\+E\+R\+T\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ Catching Failures}}.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md163}{}\doxysubsection{How to Write a Death Test}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md163}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Cygwin, and Mac (the latter three are supported since v1.\+3.\+0). {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+D\+E\+A\+T\+H\+\_\+\+I\+F\+\_\+\+S\+U\+P\+P\+O\+R\+T\+ED} are new in v1.\+4.\+0.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md164}{}\doxysubsection{Regular Expression Syntax}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md164}
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md166}{}\doxysubsection{Death Tests And Threads}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md166}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md167}{}\doxysubsection{Death Test Styles}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md167}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md168}{}\doxysubsection{Caveats}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md168}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md169}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md169}
\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md170}{}\doxysubsection{Adding Traces to Assertions}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md170}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md171}{}\doxysubsection{Propagating Fatal Failures}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md171}
...
{\itshape Availability\+:} Linux, Windows, Mac. Assertions from multiple threads are currently not supported.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md173}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md173}
...
{\itshape Availability\+:} Linux, Windows, Mac. {\ttfamily Has\+Nonfatal\+Failure()} and {\ttfamily Has\+Failure()} are available since version 1.\+4.\+0.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md174}{}\doxysection{Logging Additional Information}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md174}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md175}{}\doxysection{Sharing Resources Between Tests in the Same Test Case}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md175}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md176}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md176}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md177}{}\doxysection{Value Parameterized Tests}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md177}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md178}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md178}
...
{\itshape Availability}\+: Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+2.\+0.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md179}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md179}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily \mbox{\hyperlink{gtest__list__tests__unittest___8cc_aae3f9f4ba0f7ea179b0976679d0906c6}{I\+N\+S\+T\+A\+N\+T\+I\+A\+T\+E\+\_\+\+T\+E\+S\+T\+\_\+\+C\+A\+S\+E\+\_\+\+P()}}}, and linking with {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test case multiple times, possibly in different source files.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md180}{}\doxysection{Typed Tests}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md180}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md181}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md181}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md182}{}\doxysection{Testing Private Code}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md182}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md183}{}\doxysubsection{Static Functions}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md183}
...
\DoxyCodeLine{\}  // namespace my\_namespace}
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md185}{}\doxysection{Catching Failures}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md185}
...
\end{longtabu}
\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md186}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md186}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md187}{}\doxysection{Extending Google Test by Handling Test Events}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md187}
...
{\itshape Availability\+:} Linux, Windows, Mac; since v1.\+4.\+0.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md188}{}\doxysubsection{Defining Event Listeners}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md188}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md189}{}\doxysubsection{Using Event Listeners}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md189}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default X\+ML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md190}{}\doxysubsection{Generating Failures in Listeners}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md190}
...
We have a sample of failure-\/raising listener \href{../samples/sample10_unittest.cc}{\texttt{ here}}.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md191}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md191}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md192}{}\doxysubsection{Selecting Tests}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md192}
This section shows various options for choosing which tests to run.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md193}{}\doxysubsubsection{Listing Test Names}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md193}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md194}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md194}
...
{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md195}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md195}
...
{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md196}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md196}
...
{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md197}{}\doxysubsection{Repeating the Tests}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md197}
...
{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md198}{}\doxysubsection{Shuffling the Tests}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md198}
...
{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md199}{}\doxysubsection{Controlling Test Output}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md199}
{\itshape  This section teaches how to tweak the way test results are reported.}

{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md200}{}\doxysubsubsection{Colored Terminal Output}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md200}
...
{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md201}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md201}
...
{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md202}{}\doxysubsubsection{Generating an X\+M\+L Report}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md202}
...
{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md203}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md203}
{\itshape  }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md204}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md204}
...
{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md205}{}\doxysubsubsection{Suppressing Pop-\/ups Caused by Exceptions}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md205}
...
{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md206}{}\doxysubsubsection{Letting Another Testing Framework Drive}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md206}
...
{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md207}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md207}
...
{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md208}{}\doxysection{Fusing Google Test Source Files}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md208}
...
{\itshape }\hypertarget{md_googletest_docs__v1_5__advanced_guide_autotoc_md209}{}\doxysection{Where to Go from Here}\label{md_googletest_docs__v1_5__advanced_guide_autotoc_md209}
