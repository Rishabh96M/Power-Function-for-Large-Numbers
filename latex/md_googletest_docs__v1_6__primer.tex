...
{\itshape Note\+:} We sometimes refer to Google C++ Testing Framework informally as {\itshape Google Test}.\hypertarget{md_googletest_docs__v1_6__primer_autotoc_md391}{}\doxysection{Setting up a New Test Project}\label{md_googletest_docs__v1_6__primer_autotoc_md391}
...
If you still have questions, take a look at how Google Test\textquotesingle{}s own tests are built and use them as examples.\hypertarget{md_googletest_docs__v1_6__primer_autotoc_md392}{}\doxysection{Basic Concepts}\label{md_googletest_docs__v1_6__primer_autotoc_md392}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test cases.\hypertarget{md_googletest_docs__v1_6__primer_autotoc_md393}{}\doxysection{Assertions}\label{md_googletest_docs__v1_6__primer_autotoc_md393}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__primer_autotoc_md395}{}\doxysubsection{Binary Comparison}\label{md_googletest_docs__v1_6__primer_autotoc_md395}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__primer_autotoc_md396}{}\doxysubsection{String Comparison}\label{md_googletest_docs__v1_6__primer_autotoc_md396}
...
See also\+: For more string comparison tricks (substring, prefix, suffix, and regular expression matching, for example), see the \mbox{\hyperlink{_v1__6___advanced_guide_8md}{Advanced Google Test Guide}}.\hypertarget{md_googletest_docs__v1_6__primer_autotoc_md397}{}\doxysection{Simple Tests}\label{md_googletest_docs__v1_6__primer_autotoc_md397}
To create a test\+:
\begin{DoxyEnumerate}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__primer_autotoc_md398}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md_googletest_docs__v1_6__primer_autotoc_md398}
...
{\itshape Note}\+: Google Test automatically saves all {\itshape Google Test} flags when a test object is constructed, and restores them when it is destructed.\hypertarget{md_googletest_docs__v1_6__primer_autotoc_md399}{}\doxysection{Invoking the Tests}\label{md_googletest_docs__v1_6__primer_autotoc_md399}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__primer_autotoc_md400}{}\doxysection{Writing the main() Function}\label{md_googletest_docs__v1_6__primer_autotoc_md400}
...
But maybe you think that writing all those \mbox{\hyperlink{_c_make_c_compiler_id_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}} functions is too much work? We agree with you completely and that\textquotesingle{}s why Google Test provides a basic implementation of \mbox{\hyperlink{_c_make_c_compiler_id_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}}. If it fits your needs, then just link your test with gtest\+\_\+main library and you are good to go.\hypertarget{md_googletest_docs__v1_6__primer_autotoc_md401}{}\doxysubsection{Important note for Visual C++ users}\label{md_googletest_docs__v1_6__primer_autotoc_md401}
If you put your tests into a library and your {\ttfamily \mbox{\hyperlink{_c_make_c_compiler_id_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}}} function is in a different library or in your .exe file, those tests will not run. The reason is a \href{https://connect.microsoft.com/feedback/viewfeedback.aspx?FeedbackID=244410&siteid=210}{\texttt{ bug}} in Visual C++. When you define your tests, Google Test creates certain static objects to register them. These objects are not referenced from elsewhere but their constructors are still supposed to run. When Visual C++ linker sees that nothing in the library is referenced from other places it throws the library out. You have to reference your library with tests from your main program to keep the linker from discarding it. Here is how to do it. Somewhere in your library code declare a function\+: 
\begin{DoxyCode}{0}
