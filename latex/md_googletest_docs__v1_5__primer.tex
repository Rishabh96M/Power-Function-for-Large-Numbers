...
{\itshape Note\+:} We sometimes refer to Google C++ Testing Framework informally as {\itshape Google Test}.\hypertarget{md_googletest_docs__v1_5__primer_autotoc_md252}{}\doxysection{Setting up a New Test Project}\label{md_googletest_docs__v1_5__primer_autotoc_md252}
...
If you still have questions, take a look at how Google Test\textquotesingle{}s own tests are built and use them as examples.\hypertarget{md_googletest_docs__v1_5__primer_autotoc_md253}{}\doxysection{Basic Concepts}\label{md_googletest_docs__v1_5__primer_autotoc_md253}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test cases.\hypertarget{md_googletest_docs__v1_5__primer_autotoc_md254}{}\doxysection{Assertions}\label{md_googletest_docs__v1_5__primer_autotoc_md254}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__primer_autotoc_md256}{}\doxysubsection{Binary Comparison}\label{md_googletest_docs__v1_5__primer_autotoc_md256}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__primer_autotoc_md257}{}\doxysubsection{String Comparison}\label{md_googletest_docs__v1_5__primer_autotoc_md257}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__primer_autotoc_md259}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md_googletest_docs__v1_5__primer_autotoc_md259}
...
{\itshape Note}\+: Google Test automatically saves all {\itshape Google Test} flags when a test object is constructed, and restores them when it is destructed.\hypertarget{md_googletest_docs__v1_5__primer_autotoc_md260}{}\doxysection{Invoking the Tests}\label{md_googletest_docs__v1_5__primer_autotoc_md260}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_5__primer_autotoc_md261}{}\doxysection{Writing the main() Function}\label{md_googletest_docs__v1_5__primer_autotoc_md261}
...
But maybe you think that writing all those \mbox{\hyperlink{_c_make_c_compiler_id_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}} functions is too much work? We agree with you completely and that\textquotesingle{}s why Google Test provides a basic implementation of \mbox{\hyperlink{_c_make_c_compiler_id_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}}. If it fits your needs, then just link your test with gtest\+\_\+main library and you are good to go.\hypertarget{md_googletest_docs__v1_5__primer_autotoc_md262}{}\doxysubsection{Important note for Visual C++ users}\label{md_googletest_docs__v1_5__primer_autotoc_md262}
