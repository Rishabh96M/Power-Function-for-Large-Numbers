Now that you have read \mbox{\hyperlink{_v1__7___primer_8md}{Primer}} and learned how to write tests using Google Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md420}{}\doxysection{More Assertions}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md420}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md421}{}\doxysubsection{Explicit Success and Failure}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md421}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md422}{}\doxysubsection{Exception Assertions}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md422}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+1.\+0.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md423}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md423}
...
Google Test gives you three different options to solve this problem\+:\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md424}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md424}
...
{\itshape Availability}\+: Linux, Windows, Mac\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md425}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md425}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+4.\+1.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md426}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md426}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md427}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md427}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md429}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md429}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md430}{}\doxysubsection{Windows H\+R\+E\+S\+U\+L\+T assertions}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md430}
...
{\itshape Availability}\+: Windows.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md431}{}\doxysubsection{Type Assertions}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md431}
...
{\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md432}{}\doxysubsection{Assertion Placement}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md432}
...
If you have defined both {\ttfamily $<$$<$} and {\ttfamily \mbox{\hyperlink{namespacetesting_1_1internal_adb3c27150dbe661db0e0c4be27533460}{Print\+To()}}}, the latter will be used when Google Test is concerned. This allows you to customize how the value appears in Google Test\textquotesingle{}s output without affecting code that relies on the behavior of its {\ttfamily $<$$<$} operator.
...
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md434}{}\doxysection{Death Tests}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md434}
...
If you want to test {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()/\+A\+S\+S\+E\+R\+T\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ Catching Failures}}.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md435}{}\doxysubsection{How to Write a Death Test}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md435}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Cygwin, and Mac (the latter three are supported since v1.\+3.\+0). {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+D\+E\+A\+T\+H\+\_\+\+I\+F\+\_\+\+S\+U\+P\+P\+O\+R\+T\+ED} are new in v1.\+4.\+0.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md436}{}\doxysubsection{Regular Expression Syntax}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md436}
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md438}{}\doxysubsection{Death Tests And Threads}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md438}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md439}{}\doxysubsection{Death Test Styles}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md439}
...
You can do this in {\ttfamily \mbox{\hyperlink{_c_make_c_compiler_id_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}}} to set the style for all death tests in the binary, or in individual tests. Recall that flags are saved before running each test and restored afterwards, so you need not do that yourself. For example\+:
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md440}{}\doxysubsection{Caveats}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md440}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md441}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md441}
\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md442}{}\doxysubsection{Adding Traces to Assertions}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md442}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md443}{}\doxysubsection{Propagating Fatal Failures}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md443}
...
{\itshape Availability\+:} Linux, Windows, Mac. Assertions from multiple threads are currently not supported.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md445}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md445}
...
{\itshape Availability\+:} Linux, Windows, Mac. {\ttfamily Has\+Nonfatal\+Failure()} and {\ttfamily Has\+Failure()} are available since version 1.\+4.\+0.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md446}{}\doxysection{Logging Additional Information}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md446}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md447}{}\doxysection{Sharing Resources Between Tests in the Same Test Case}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md447}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md448}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md448}
...
You should call {\ttfamily \mbox{\hyperlink{namespacetesting_a460d7b998622e332392c1e00be3a60d5}{Add\+Global\+Test\+Environment()}}} before {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()}}} is called, probably in {\ttfamily \mbox{\hyperlink{_c_make_c_compiler_id_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}}}. If you use {\ttfamily gtest\+\_\+main}, you need to call this before {\ttfamily \mbox{\hyperlink{_c_make_c_compiler_id_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}}} starts for it to take effect. One way to do this is to define a global variable like this\+:
...
However, we strongly recommend you to write your own {\ttfamily \mbox{\hyperlink{_c_make_c_compiler_id_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}}} and call {\ttfamily \mbox{\hyperlink{namespacetesting_a460d7b998622e332392c1e00be3a60d5}{Add\+Global\+Test\+Environment()}}} there, as relying on initialization of global variables makes the code harder to read and may cause problems when you register multiple environments from different translation units and the environments have dependencies among them (remember that the compiler doesn\textquotesingle{}t guarantee the order in which global variables from different translation units are initialized).

{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md449}{}\doxysection{Value Parameterized Tests}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md449}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md450}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md450}
...
{\itshape Availability}\+: Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+2.\+0.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md451}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md451}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily \mbox{\hyperlink{gtest__list__tests__unittest___8cc_aae3f9f4ba0f7ea179b0976679d0906c6}{I\+N\+S\+T\+A\+N\+T\+I\+A\+T\+E\+\_\+\+T\+E\+S\+T\+\_\+\+C\+A\+S\+E\+\_\+\+P()}}}, and linking with {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test case multiple times, possibly in different source files.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md452}{}\doxysection{Typed Tests}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md452}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md453}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md453}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md454}{}\doxysection{Testing Private Code}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md454}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md455}{}\doxysubsection{Static Functions}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md455}
...
\DoxyCodeLine{\}  // namespace my\_namespace}
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md457}{}\doxysection{Catching Failures}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md457}
...
\end{longtabu}
\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md458}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md458}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md459}{}\doxysection{Extending Google Test by Handling Test Events}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md459}
...
{\itshape Availability\+:} Linux, Windows, Mac; since v1.\+4.\+0.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md460}{}\doxysubsection{Defining Event Listeners}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md460}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md461}{}\doxysubsection{Using Event Listeners}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md461}
...
\begin{DoxyItemize}
\item note the \char`\"{}s\char`\"{} at the end of the name) in your {\ttfamily \mbox{\hyperlink{_c_make_c_compiler_id_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}}} function, before calling {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()}}}\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{int main(int argc, char** argv) \{}
\DoxyCodeLine{  ::testing::InitGoogleTest(\&argc, argv);}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default X\+ML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md462}{}\doxysubsection{Generating Failures in Listeners}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md462}
...
We have a sample of failure-\/raising listener \href{../samples/sample10_unittest.cc}{\texttt{ here}}.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md463}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md463}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md464}{}\doxysubsection{Selecting Tests}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md464}
This section shows various options for choosing which tests to run.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md465}{}\doxysubsubsection{Listing Test Names}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md465}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md466}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md466}
...
{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md467}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md467}
...
{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md468}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md468}
...
{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md469}{}\doxysubsection{Repeating the Tests}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md469}
...
{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md470}{}\doxysubsection{Shuffling the Tests}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md470}
...
{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md471}{}\doxysubsection{Controlling Test Output}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md471}
{\itshape  This section teaches how to tweak the way test results are reported.}

{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md472}{}\doxysubsubsection{Colored Terminal Output}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md472}
...
{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md473}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md473}
...
{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md474}{}\doxysubsubsection{Generating an X\+M\+L Report}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md474}
...
{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md475}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md475}
{\itshape  }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md476}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md476}
...
{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md477}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md477}
...
{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md478}{}\doxysubsubsection{Letting Another Testing Framework Drive}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md478}
{\itshape  If you work on a project that has already been using another testing framework and is not ready to completely switch to Google Test yet, you can get much of Google Test\textquotesingle{}s benefit by using its assertions in your existing tests. Just change your {\ttfamily \mbox{\hyperlink{_c_make_c_compiler_id_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}}} function to look like\+:}
...
{\itshape If you don\textquotesingle{}t write {\ttfamily \+::testing\+::\+G\+T\+E\+S\+T\+\_\+\+F\+L\+A\+G(throw\+\_\+on\+\_\+failure) = true;} in your {\ttfamily \mbox{\hyperlink{_c_make_c_compiler_id_8c_a0ddf1224851353fc92bfbff6f499fa97}{main()}}}, you can alternatively enable this feature by specifying the {\ttfamily -\/-\/gtest\+\_\+throw\+\_\+on\+\_\+failure} flag on the command-\/line or setting the {\ttfamily G\+T\+E\+S\+T\+\_\+\+T\+H\+R\+O\+W\+\_\+\+O\+N\+\_\+\+F\+A\+I\+L\+U\+RE} environment variable to a non-\/zero value.}
...
{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md479}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md479}
...
{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md480}{}\doxysection{Fusing Google Test Source Files}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md480}
...
{\itshape }\hypertarget{md_googletest_docs__v1_7__advanced_guide_autotoc_md481}{}\doxysection{Where to Go from Here}\label{md_googletest_docs__v1_7__advanced_guide_autotoc_md481}
