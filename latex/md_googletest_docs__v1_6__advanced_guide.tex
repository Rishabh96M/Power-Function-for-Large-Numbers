Now that you have read \mbox{\hyperlink{_v1__6___primer_8md}{Primer}} and learned how to write tests using Google Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md281}{}\doxysection{More Assertions}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md281}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md282}{}\doxysubsection{Explicit Success and Failure}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md282}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md283}{}\doxysubsection{Exception Assertions}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md283}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+1.\+0.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md284}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md284}
...
Google Test gives you three different options to solve this problem\+:\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md285}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md285}
...
{\itshape Availability}\+: Linux, Windows, Mac\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md286}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md286}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+4.\+1.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md287}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md287}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md288}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md288}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md290}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md290}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md291}{}\doxysubsection{Windows H\+R\+E\+S\+U\+L\+T assertions}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md291}
...
{\itshape Availability}\+: Windows.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md292}{}\doxysubsection{Type Assertions}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md292}
...
{\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md293}{}\doxysubsection{Assertion Placement}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md293}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md295}{}\doxysection{Death Tests}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md295}
...
If you want to test {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()/\+A\+S\+S\+E\+R\+T\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ Catching Failures}}.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md296}{}\doxysubsection{How to Write a Death Test}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md296}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Cygwin, and Mac (the latter three are supported since v1.\+3.\+0). {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+D\+E\+A\+T\+H\+\_\+\+I\+F\+\_\+\+S\+U\+P\+P\+O\+R\+T\+ED} are new in v1.\+4.\+0.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md297}{}\doxysubsection{Regular Expression Syntax}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md297}
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md299}{}\doxysubsection{Death Tests And Threads}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md299}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md300}{}\doxysubsection{Death Test Styles}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md300}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md301}{}\doxysubsection{Caveats}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md301}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md302}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md302}
\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md303}{}\doxysubsection{Adding Traces to Assertions}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md303}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md304}{}\doxysubsection{Propagating Fatal Failures}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md304}
...
{\itshape Availability\+:} Linux, Windows, Mac. Assertions from multiple threads are currently not supported.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md306}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md306}
...
{\itshape Availability\+:} Linux, Windows, Mac. {\ttfamily Has\+Nonfatal\+Failure()} and {\ttfamily Has\+Failure()} are available since version 1.\+4.\+0.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md307}{}\doxysection{Logging Additional Information}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md307}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md308}{}\doxysection{Sharing Resources Between Tests in the Same Test Case}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md308}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md309}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md309}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md310}{}\doxysection{Value Parameterized Tests}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md310}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md311}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md311}
...
{\itshape Availability}\+: Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+2.\+0.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md312}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md312}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily \mbox{\hyperlink{gtest__list__tests__unittest___8cc_aae3f9f4ba0f7ea179b0976679d0906c6}{I\+N\+S\+T\+A\+N\+T\+I\+A\+T\+E\+\_\+\+T\+E\+S\+T\+\_\+\+C\+A\+S\+E\+\_\+\+P()}}}, and linking with {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test case multiple times, possibly in different source files.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md313}{}\doxysection{Typed Tests}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md313}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md314}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md314}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md315}{}\doxysection{Testing Private Code}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md315}
...
\end{DoxyItemize}\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md316}{}\doxysubsection{Static Functions}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md316}
...
\DoxyCodeLine{\}  // namespace my\_namespace}
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md318}{}\doxysection{Catching Failures}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md318}
...
\end{longtabu}
\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md319}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md319}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md320}{}\doxysection{Extending Google Test by Handling Test Events}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md320}
...
{\itshape Availability\+:} Linux, Windows, Mac; since v1.\+4.\+0.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md321}{}\doxysubsection{Defining Event Listeners}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md321}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md322}{}\doxysubsection{Using Event Listeners}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md322}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default X\+ML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md323}{}\doxysubsection{Generating Failures in Listeners}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md323}
...
We have a sample of failure-\/raising listener \href{../samples/sample10_unittest.cc}{\texttt{ here}}.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md324}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md324}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md325}{}\doxysubsection{Selecting Tests}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md325}
This section shows various options for choosing which tests to run.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md326}{}\doxysubsubsection{Listing Test Names}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md326}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md327}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md327}
...
{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md328}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md328}
...
{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md329}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md329}
...
{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md330}{}\doxysubsection{Repeating the Tests}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md330}
...
{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md331}{}\doxysubsection{Shuffling the Tests}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md331}
...
{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md332}{}\doxysubsection{Controlling Test Output}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md332}
{\itshape  This section teaches how to tweak the way test results are reported.}

{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md333}{}\doxysubsubsection{Colored Terminal Output}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md333}
...
{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md334}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md334}
...
{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md335}{}\doxysubsubsection{Generating an X\+M\+L Report}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md335}
...
{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md336}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md336}
{\itshape  }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md337}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md337}
...
{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md338}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md338}
...
{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md339}{}\doxysubsubsection{Letting Another Testing Framework Drive}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md339}
...
{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md340}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md340}
...
{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md341}{}\doxysection{Fusing Google Test Source Files}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md341}
...
{\itshape }\hypertarget{md_googletest_docs__v1_6__advanced_guide_autotoc_md342}{}\doxysection{Where to Go from Here}\label{md_googletest_docs__v1_6__advanced_guide_autotoc_md342}
